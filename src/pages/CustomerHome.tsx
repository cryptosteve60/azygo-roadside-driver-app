  ...
  return <div className="flex flex-col gap-5">
      ...
      <section>
        ...
        <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          <ServiceCard type="battery" title="Battery Jump" price="$49" description="Dead battery? We'll get you back on the road fast." />
          <ServiceCard type="tire" title="Tire Change" price="$69" description="Flat tire? We'll swap it with your spare quickly." />
          <ServiceCard type="fuel" title="Fuel Delivery" price="$45" description="Out of gas? We'll bring fuel right to you." />
          <ServiceCard type="lockout" title="Lockout Service" price="$75" description="Locked out? We'll help you get back in safely." />
          <ServiceCard type="tow" title="Towing Service" price="$99" description="Need a tow? We'll get your vehicle to safety." />
          <ServiceCard type="charging" title="EV Charging" price="$59" description="Electric vehicle out of power? Mobile charging available." />
        </div>
      </section>
    </div>;
};
